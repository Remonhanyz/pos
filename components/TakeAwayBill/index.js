  ...
  return (
    <div className={`${styles.BillContainer} h-100 d-flex flex-column `}>
      <div className="row ">
        ...
        <div className={`col-4 ${styles.orderType} text-end`}> Take Away</div>
      </div>
      <div className={`${styles.orderDate} `}>January 23, 2022 - 5:00 pm</div>
      <div ref={drop} className={`pt-1 d-flex flex-column overflow-auto pe-1`}>
        <BillOrderCard
                ...
                >
                  {({ touched, errors, handleSubmit }) => (
                    <Form className={`row g-3`}>
                      ...
                      <div className={`col-md-12 ${styles.inputText} mt-2`}>
